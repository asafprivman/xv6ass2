...
main(int argc, char *argv[])
{
  ...
  47:	e8 7d 04 00 00       	call   4c9 <unlink>
  ...
  66:	c7 44 24 04 f1 09 00 	movl   $0x9f1,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5aa:	0f b6 80 bc 0c 00 00 	movzbl 0xcbc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 707:	75 09                	jne    712 <printf+0x101>
          s = "(null)";
 709:	c7 45 f4 0a 0a 00 00 	movl   $0xa0a,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7d3:	a1 d8 0c 00 00       	mov    0xcd8,%eax
...
free(void *ap)
{
 ...
 89e:	a3 d8 0c 00 00       	mov    %eax,0xcd8
}
 8a3:	c9                   	leave  
 8a4:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8f1:	e8 ce fe ff ff       	call   7c4 <free>
  return freep;
 8f6:	a1 d8 0c 00 00       	mov    0xcd8,%eax
}
 8fb:	c9                   	leave  
 8fc:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 90f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 912:	a1 d8 0c 00 00       	mov    0xcd8,%eax
 917:	89 45 f0             	mov    %eax,-0x10(%ebp)
 91a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 91e:	75 23                	jne    943 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 920:	c7 45 f0 d0 0c 00 00 	movl   $0xcd0,-0x10(%ebp)
 927:	8b 45 f0             	mov    -0x10(%ebp),%eax
 92a:	a3 d8 0c 00 00       	mov    %eax,0xcd8
 92f:	a1 d8 0c 00 00       	mov    0xcd8,%eax
 934:	a3 d0 0c 00 00       	mov    %eax,0xcd0
    base.s.size = 0;
 939:	c7 05 d4 0c 00 00 00 	movl   $0x0,0xcd4
 940:	00 00 00 
  }
 ...
 996:	a3 d8 0c 00 00       	mov    %eax,0xcd8
      return (void*)(p + 1);
 ...
 9a1:	eb 38                	jmp    9db <malloc+0xde>
    ...
    if(p == freep)
 9a3:	a1 d8 0c 00 00       	mov    0xcd8,%eax
